...
class _AccountDetailState extends State<AccountDetail> {
  ...
  void uploadImage() async {
    ...
    await uploadTask.ref.getDownloadURL().then((imgUrl) async {
      ...
      accountController.myImgUrl.value = imgUrl.toString();
      EasyLoading.dismiss();
                  ...
                  Obx(() => Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: accountController.myImgUrl.toString(),
                        fit: BoxFit.fill,
                      ),
                    ),
                  )),
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    accountController.myname.value.toString(),
                                    style: TextStyle(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    accountController.myemail.value.toString(),
                                    style: TextStyle(
                                        fontSize: 15, color: Colors.black),
                                  ),
                                ],
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    accountController.myphone.value.toString(),
                                    style: TextStyle(
                                        fontSize: 15, color: Colors.black),
                                  ),
                                ],
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              TextButton(
                  onPressed: () {
                    if (textvalue != "") {
                      accountController.myname.value = textvalue;
                      setname(textvalue);
                      setState(() {
                        Navigator.pop(context);
                      });
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              TextButton(
                  onPressed: () {
                    if (textvalue != "") {
                      accountController.myemail.value = textvalue;
                      setemail(textvalue);
                      setState(() {
                        Navigator.pop(context);
                      });
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              TextButton(
                  onPressed: () {
                    if (textvalue != "") {
                      accountController.myphone.value = textvalue;
                      setphone(textvalue);
                      setState(() {
                        Navigator.pop(context);
                      });
